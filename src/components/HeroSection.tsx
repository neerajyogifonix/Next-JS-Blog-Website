        ...
        <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                    ...
                    <p
                className="font-sans text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl">
                ...
                >
                <Button size="lg" className="group">Read the Latest Post <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" /></Button>
                </motion.div>
                </motion.div>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="bg-background/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-primary/20">
                                <div className="text-center space-y-4">
                                    ...
                                    <div className="text-lg font-medium text-foreground">Notes</div>
